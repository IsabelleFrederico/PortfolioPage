    ...
    return (
        <>
            <button
                ...
                className="cursor-pointer z-20 fixed top-12 right-12 p-3 bg-indigo-600 w-11 h-11 rounded-md"
            >
                <div
...
const MenuButton = (props) => {
    ...
    return (
        <button
            onClick={onClick}
            className="cursor-pointer text-2xl font-bold cursor-pointer hover:text-indigo-600 transition-colors"
        >
            {label}
        </button>
    )
